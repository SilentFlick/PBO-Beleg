...
insert into professor_lecturer values (null, 'Ortmanns Wolfgang', 'Wirtschaftsingenieurwesen');
insert into professor_lecturer values (null, 'Sonntag Ralph', 'Wirtschaftsingenieurwesen');
insert into professor_lecturer values (null, 'Gestring Ingo', 'Wirtschaftsingenieurwesen');
...
INSERT INTO posts(post_id, from_user, to_user, faculty, title, content) VALUES(null, 3, null,'Informatik/Mathematik/Mathematik', 'Hausaufgaben für Weihnachten', 'Randomly creates a first and last name, using an array of common first and last names. GenerateName() returns a string[2] (2 element array) containing the randomly chosen first and last name. This is written as a class so it can be instantiated and called numerous times when creating large datasets.');
INSERT INTO posts(post_id, from_user, to_user, faculty, title, content) VALUES(null, null, null, 'Informatik/Mathematik/Mathematik', 'Why do we have assaignments?', 'Because we are lazy and we want to make you lazy too');
